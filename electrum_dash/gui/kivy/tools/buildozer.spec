...
title = PacGlobal Electrum

# (str) Package name
package.name = Electrum_PAC
...
source.include_exts = py,png,jpg,kv,atlas,ttf,txt,gif,pem,mo,vs,fs,json,gz
...
icon.filename = %(source.dir)s/electrum_dash/gui/icons/electrum-pac.png
